...
const UsuariosList: React.FC = () => {
  ...
  const renderCard = (usuario: any) => (
    <div className="bg-card-background backdrop-blur-lg p-6 rounded-2xl border border-border hover:border-text-secondary transition-all duration-300 hover:shadow-xl group">
